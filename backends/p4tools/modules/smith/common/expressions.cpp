...
IR::Type_Boolean *ExpressionGenerator::genBoolType() { return new IR::Type_Boolean(); }

IR::Type_InfInt *ExpressionGenerator::genIntType() { return new IR::Type_InfInt(); }

IR::Type *ExpressionGenerator::pickRndBaseType(const std::vector<int64_t> &type_probs) {
...
IR::Type *ExpressionGenerator::pickRndType(TyperefProbs type_probs) {
...
IR::Type_Bits *ExpressionGenerator::genBitType(bool isSigned) {
...
IR::Expression *ExpressionGenerator::constructBinaryBitExpr(const IR::Type_Bits *tb) {
    ...
    switch (Utils::getRandInt(percent)) {
        ...
        case 12: {
            ...
            auto *tl = new IR::Type_Bits(typeWidth - split, false);
...
IR::Expression *ExpressionGenerator::constructTernaryBitExpr(const IR::Type_Bits *tb) {
    ...
    switch (Utils::getRandInt(percent)) {
        case 0: {
            ...
            auto *sliceType = new IR::Type_Bits(newTypeSize, false);
...
IR::Expression *ExpressionGenerator::constructCmpExpr() {
    ...
    auto *newType = new IR::Type_Bits(newTypeSize, false);
